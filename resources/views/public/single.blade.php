  ...
  <div class="page-wrapper">
      <div class="blog-title-area">
          <ol class="breadcrumb hidden-xs-down">
              ...
              <li class="breadcrumb-item"><a href="/category/{{ $post->category->id }}">{{ $post->category->name }}</a></li>
              <li class="breadcrumb-item active">{{ $post->name }}</li>
          </ol>
          <h3>{{ $post->name }}</h3>

          <div class="blog-meta big-meta">
              <small><a href="javascript:void(0)" title="">21 July, 2017</a></small>
              <small><a href="javascript:void(0)" title="">by JutLY</a></small>
              <small><a href="javascript:void(0)" title=""><i class="fa fa-eye"></i> {{ $post->view_counter + 123 }}</a></small>
          </div><!-- end meta -->
      </div><!-- end title -->
